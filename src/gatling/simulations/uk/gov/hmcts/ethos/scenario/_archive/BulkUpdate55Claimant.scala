...
object BulkUpdate55Claimant {
  ...
  val CaseProviderSeq = csv("caseFeeder_55claimant.csv").circular
  ...
  val ethosBulkUpdate =  exec(
    ...
    .exec(http("TX01_Ethos_bulkupdate_55claimant_saveeventtoken")
    ...
    .exec(http("TX02_Ethos_bulkupdate_55claimant")

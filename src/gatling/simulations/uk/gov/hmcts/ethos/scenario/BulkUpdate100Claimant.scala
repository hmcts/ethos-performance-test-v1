...
object BulkUpdate100Claimant {
  ...
  val CaseProviderSeq = csv("caseFeeder_100claimant.csv").circular
  ...
  val ethosBulkUpdate =  exec(
    ...
    .exec(http("TX01_Ethos_bulkupdate_100claimant_saveeventtoken")
    ...
    .exec(http("TX02_Ethos_bulkupdate_100claimant")
